...
// File generated at :: Fri Jun 22 2012 01:05:18 GMT-0700 (Pacific Daylight Time)
...
FileTransfer.prototype.upload = function(filePath, server, successCallback, errorCallback, options, trustAllHosts) {
    ...
    console.log("WP7 specific FileTransfer.upload called with options::" + JSON.stringify(options));
    // sanity parameter checking
    if (!filePath || !server) throw new Error("FileTransfer.upload requires filePath and server URL parameters at the minimum.");
    // check for options
    var fileKey = null;
    ...
    if (options) {
        ...
        if (options.params) {
            if(params && typeof params != typeof "") {
                ...
                params = encodeURIComponent(arrParams.join("&"));
            }
        }
    }
    ...
    console.log("new patames look like this :: " + params);
